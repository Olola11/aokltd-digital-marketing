    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          className="w-full bg-white border border-gray-300 rounded-md py-3 px-4 font-sans text-base text-[#00008B] placeholder:text-gray-400 focus:outline-none focus:border-[#4A90E2] focus:ring-1 focus:ring-[#4A90E2]/20 transition-colors"
        />
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full bg-white border border-gray-300 rounded-md py-3 px-4 font-sans text-base text-[#00008B] placeholder:text-gray-400 focus:outline-none focus:border-[#4A90E2] focus:ring-1 focus:ring-[#4A90E2]/20 transition-colors resize-y min-h-[160px]"
        />
      </div>
